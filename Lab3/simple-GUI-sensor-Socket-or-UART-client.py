...
def main():
        ...
        scan_command_Button = tk.Button(text ="Press to drive forward", command = drive_forward)
        scan_command_Button.pack() # Pack the button into the window for display
...
def socket_thread():
        ...
        filename = 'Lab3_Sensor_Data.txt' # Name of file you want to store sensor data from your sensor scan command
        ...
        while send_message != 'quit\n':
                ...
                if (send_message == "M\n") or (send_message == "m\n"):
                        ...
                        os.system("CyBot-Plot-Sensor-Scan-Values-From-File.py")
